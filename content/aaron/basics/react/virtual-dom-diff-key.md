---
id: aaron-basic-react-virtual-dom-diff-key
title: 虚拟 DOM、Diff 和 key 怎么理解，为什么使用它们
aliases: [请讲讲：虚拟 DOM、Diff 和 key 怎么理解，为什么使用它们, 关于“虚拟 DOM、Diff 和 key 怎么理解，为什么使用它们”，你会怎样回答？]
category: react
difficulty: 进阶
priority: high
projects: []
keywords: [虚拟DOM, Diff, key, 协调]
---

# 虚拟 DOM、Diff 和 key 怎么理解，为什么使用它们
