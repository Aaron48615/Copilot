---
id: aaron-basic-react-synthetic-native-events
title: React 合成事件和原生事件的关系
aliases: [请讲讲：React 合成事件和原生事件的关系, 关于“React 合成事件和原生事件的关系”，你会怎样回答？]
category: react
difficulty: 进阶
priority: normal
projects: []
keywords: [合成事件, 原生事件, 事件委托]
---
