---
id: aaron-basic-react-redux-async-middleware
title: Redux 中间件、Thunk 和 Saga 怎么处理异步
aliases: [请讲讲：Redux 中间件、Thunk 和 Saga 怎么处理异步, 关于“Redux 中间件、Thunk 和 Saga 怎么处理异步”，你会怎样回答？]
category: react
difficulty: 进阶
priority: normal
projects: []
keywords: [Redux, 中间件, Thunk, Saga]
---

# Redux 中间件、Thunk 和 Saga 怎么处理异步
